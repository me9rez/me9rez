...
- **GIS 开发**：从数据到呈现都做过 —— 地形切片生成、MBTiles 瓦片读写、Quantized Mesh 解码，以及 WebGL / WebGPU 的三维地形与矢量渲染
- **前端工程**：Vue / React / TypeScript 是主力，日常在 Rsbuild、Vite 上做构建与工程化，也输出过 Electron、NW.js 的项目模板
...
<p align="center">
  <sub>想聊 GIS、前端或 AI Agent 相关的事，邮件随时可达。</sub>
</p>
